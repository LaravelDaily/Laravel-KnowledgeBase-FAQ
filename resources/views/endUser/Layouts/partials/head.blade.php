...
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap"
      rel="stylesheet">
<!-- Line Awesome CDN CSS V6.4.2  -->
<link rel="stylesheet"
      href="https://maxst.icons8.com/vue-static/landings/line-awesome/line-awesome/1.3.0/css/line-awesome.min.css">
<!-- Animate CDN CSS V4.1.1 -->
...
@if(app()->getLocale() === 'ar')
    ...
    <!-- Main Style Sheet -->
    <link rel="stylesheet" href="{{ asset('assetsEndUser/content/css/main-rtl.css') }}">
@endif
<!-- Bootsrap CDN CSS V5.3.1  -->
...
<!-- Main Style Sheet -->
<link rel="stylesheet" href="{{ asset('assetsEndUser/content/css/main-ltr.css') }}">
